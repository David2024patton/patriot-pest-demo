...
<section id="hero">
  ...
  <div class="wrap hero-grid">
    <div>
      ...
      <p class="hero-sub">Pest control for homes and businesses across <b>Washington, Idaho, Oregon &amp; Arizona</b>. Products are safe for your family and pets. <b>Same-day service</b> when it can't wait.</p>
      <div class="hero-ctas">
...
<section id="threats">
  <div class="wrap threats-head">
    ...
    <p class="lead" data-reveal><?= $view->e($pestCount) ?> types of pests are active in your region right now. We know each one and treat them with products that are safe for your family. Scroll the board.</p>
  </div>
  ...
  <div class="wrap">
    ...
    <div class="split" style="margin-top:1.5rem">
      ...
      <div>
        ...
        <p class="lead" data-reveal>Patriot Pest Control was founded by <b>U.S. military veteran Skyler Rose</b>. He runs the company the way he was trained: on time, honest, and thorough. Over a decade in the field, thousands of homes and businesses protected.</p>
        <blockquote class="quote" data-reveal>
          <p>I served this country, and I built this company on the same rules: show up when you say you will, do the job right, and don't sell people things they don't need. We get rid of pests, and we treat your home with respect while we're in it.</p>
...
<section id="pricing" class="block alt">
  <div class="wrap">
    ...
    <div class="grid g4">
      <div class="card plan" data-reveal><span class="plan-tier">BRONZE</span><h3>One-Time Treatment</h3><p>One visit for an active infestation. Fast, thorough, guaranteed.</p><a class="more" href="/prices">View Pricing ▸</a></div>
      <div class="card plan" data-reveal><span class="plan-tier">SILVER</span><h3>Seasonal Protection</h3><p>Quarterly treatments that keep pests out through every season.</p><a class="more" href="/prices">View Pricing ▸</a></div>
      <div class="card plan featured" data-reveal><span class="rec">RECOMMENDED</span><span class="plan-tier">GOLD</span><h3>Year-Round Protection</h3><p>Our best value. Year-round coverage, priority scheduling, and free re-treatments.</p><a class="more" href="/prices">View Pricing ▸</a></div>
      <div class="card plan" data-reveal><span class="plan-tier">PLATINUM</span><h3>Premium Comprehensive</h3><p>Everything in Gold, plus interior and specialty pest coverage.</p><a class="more" href="/prices">View Pricing ▸</a></div>
    </div>
  </div>
</section>
...
<section id="guarantee" class="block">
  <div class="wrap">
    ...
    <h2 data-reveal>We stand behind <em>every treatment.</em></h2>
    <div class="stat-grid">
    ...
    <div class="promise" data-reveal><b>🛡️ Our promise:</b> if pests return between scheduled visits, we re-treat at no additional cost. No hassles, no excuses. Licensed, bonded, and insured. Products are low-toxicity and safe for kids, pets, and the environment.</div>
  </div>
</section>
...
<section id="final" class="block cta-band">
  <div class="wrap" style="text-align:center">
    ...
    <p class="lead" data-reveal>Call the line or send a request online. Same-day service is available across all four states. Free quotes, no hidden fees.</p>

...
<div class="app"><div class="wrap">
  ...
  <?php elseif ($type === 'staff'): ?>
    <div class="panel">
      ...
      <dl class="kv" style="margin-top:.8rem">
        <dt>Name</dt><dd><?= $view->e($record['name'] ?? '—') ?></dd>
        <dt>Email</dt><dd><?= $view->e($record['email'] ?? '—') ?></dd>
        ...
        <dt>Last Sign-In</dt><dd><?= $view->e(!empty($record['last_login']) ? date('M j, Y H:i', strtotime($record['last_login'])) : '—') ?></dd>
        <dt>Member Since</dt><dd><?= $view->e(!empty($record['created_at']) ? date('M j, Y', strtotime($record['created_at'])) : '—') ?></dd>
      </dl>
    </div>
  ...
  <?php else: ?>
    <div class="panel">
      ...
      <dl class="kv" style="margin-top:.8rem">
        <dt>Account #</dt><dd class="mono"><?= $view->e($record['account_number'] ?? '—') ?></dd>
        <dt>Name</dt><dd><?= $view->e($record['name'] ?? '—') ?></dd>
        <dt>Email</dt><dd><?= $view->e($record['email'] ?? '—') ?></dd>
        <dt>Phone</dt><dd><?= $view->e($record['phone'] ?? '—') ?></dd>
